...
/**
 * Created by Maria on 17/10/2015.
 */
public class MostrarProveedorFactura {
    ...
    @FXML private void modifyfac(ActionEvent event) {
        ...
        URL url = getClass().getResource("vistaFacturaProveedor.fxml");
        ...
        ((ProveedorFacturaFORM) fxmlloader.getController()).setContext(currentContext);
